...
L["When a pet is loaded below max level, draw attention to the Safari Hat button, including summoning the window if it's not on screen."] = "當寵物載入時的等級低於最高等級，將注意力轉移到狩旅團之帽按鈕，如果視窗不在畫面上就顯示出來。"
