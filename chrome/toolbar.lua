...
local toolbarLayouts = {
    ...
    [2] = {"HealButton","BandageButton","SafariHatButton","LesserPetTreatButton","PetTreatButton"
    -- Added in WOD
    --,"LevelingStoneButton"
    ,"RarityStoneButton","ImportTeamButton","ExportTeamButton","RandomTeamButton","SummonPetButton"},
    [3] = {"HealButton","BandageButton","SafariHatButton","LesserPetTreatButton","PetTreatButton"
    -- Added in WOD
    -- ,"LevelingStoneButton"
    ,"RarityStoneButton","ImportTeamButton","ExportTeamButton","RandomTeamButton","SummonPetButton"}
}
...
function rematch.toolbar:SPELL_UPDATE_COOLDOWN()
    ...
    if self.RarityStoneButton:IsVisible() then
        --self:SetCooldown(self.LevelingStoneButton.Cooldown,"item",self.LevelingStoneButton:GetAttribute("item"))
        self:SetCooldown(self.RarityStoneButton.Cooldown,"item",98715)
    end
end
