...
rematch.optionsList = {
	...
	{type="check", group=9, text=L["Safari Hat Reminder"], var="SafariHatShine", update=true, tooltip=L["When a pet is loaded below max level, draw attention to the Safari Hat button, including summoning the window if it's not on screen."]},
